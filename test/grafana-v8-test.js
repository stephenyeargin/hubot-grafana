...
describe('grafana v8', () => {
  ...
  context('ensure all listeners are registered', () => {
    it('registers a dashboard listener', function () {
      return expect(this.robot.respond).to.have.been.calledWith(/(?:grafana|graph|graf) (?:dash|dashboard|db) ([A-Za-z0-9\-\:_]+)(.*)?/i);
    });

    it('registers a list listener', function () {
      return expect(this.robot.respond).to.have.been.calledWith(/(?:grafana|graph|graf) list\s?(.+)?/i);
    });

    it('registers a search listener', function () {
      return expect(this.robot.respond).to.have.been.calledWith(/(?:grafana|graph|graf) search (.+)/i);
    });
  });
  ...
  context('ask hubot to list dashboards', () => {
    ...
    it('hubot should respond with a list of dashboards', () => expect(room.messages).to.eql([
  ...
  context('ask hubot to list dashboards filterd by tag', () => {
    ...
    it('hubot should respond with a list of dashboards with tag', () => expect(room.messages).to.eql([
  ...
  context('ask hubot to search dashboards', () => {
    ...
    it('hubot should respond with a matching dashboard', () => expect(room.messages).to.eql([
  ...
  context('ask hubot to return a specific panel that does not exist', () => {
    ...
    it('hubot should respond with an error message', () => expect(room.messages).to.eql([
  ...
  context('ask hubot to return different default image sizes', () => {
    ...
    it('hubot should respond with the custom image size set in environment', () => expect(room.messages).to.eql([
      ['alice', 'hubot graf db 97PlYC7Mk:3'],
  ...
  context('ask hubot to return a specific panel with a custom size', () => {
    ...
    it('hubot should respond with a resized image specified in request', () => expect(room.messages).to.eql([
  ...
  context('ask hubot for templated dashboard', () => {
    ...
    it('hubot should respond with a templated graph', () => expect(room.messages).to.eql([
  ...
  context('ask hubot for list of alerts', () => {
    ...
    it('hubot should respond with a list of alerts', () => expect(room.messages).to.eql([
  ...
  context('ask hubot to pause an alert', () => {
    ...
    it('hubot should respond with a successful paused response', () => expect(room.messages).to.eql([
  ...
  context('ask hubot to un-pause an alert', () => {
    ...
    it('hubot should respond with a successful un-paused response', () => expect(room.messages).to.eql([
